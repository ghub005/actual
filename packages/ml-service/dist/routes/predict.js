...
import { buildCategorizationPrompt, parseCategorizationResponse, buildBatchCategorizationPrompt, parseBatchCategorizationResponse, } from '../prompts/categorization.js';
...
predictRouter.post('/predict', async (req, res) => {
    ...
    try {
        ...
        const messages = buildCategorizationPrompt(body.transaction, body.categories, body.recentCorrections);
        let response;
...
predictRouter.post('/predict/batch', async (req, res) => {
    ...
    try {
        ...
        const messages = buildBatchCategorizationPrompt(body.transactions, body.categories, body.recentCorrections);
        const llmProvider = getProvider();
